...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(UserPrincipalDetailsService userDetailsService, AuthEntryPointJwt unauthorizedHandler) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .requestMatchers("/announcement/getByNrCrt/**")
                .permitAll()
                .requestMatchers("/announcement/getById/**")
                .permitAll()
                .requestMatchers("/announcement/filter/**")
                .permitAll()
