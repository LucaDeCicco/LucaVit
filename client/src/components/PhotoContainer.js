        ...
        <React.Fragment>
            ...
            <Container maxWidth="sm" style={{marginLeft: '5em', width: "120em"}}>
                <Box sx={{
                    ...
                    {photoIndex !== 0 ?
                        <KeyboardArrowLeftIcon onClick={previousPhoto} style={{marginRight: '1em', cursor: "pointer"}}/>
                    ...
                    {photoIndex < data.length - 1 ?
                        <KeyboardArrowRightIcon onClick={nextPhoto} style={{marginLeft: '1em', cursor: "pointer"}}/>
